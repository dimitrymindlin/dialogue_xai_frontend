...
export const adultQuestionnaireConfig: QuestionnaireConfig = {
    questions: [
...
export const adultStaticQuestionnaireConfig: QuestionnaireConfig = {
    questions: [
...
export const diabetesQuestionnaireConfig: QuestionnaireConfig = {
    questions: [
        ...
        'The chatbot behavior does not make sense.',
        'The Chatbot does its task well',
        'I dislike the Chatbot.',
        'I am capable of succeeding with the Chatbot',
    ],
    attentionCheck: {
        questionIndex: 13, // Position of attention check question
        correctAnswer: "-2",
        checkId: "diabetes_attention"
    },
    title: "Please answer the following questions and give us feedback to improve.",
    subtitle: ""
};
...
export function getQuestionnaireConfig(dataset: string, studyGroup?: string): QuestionnaireConfig {
    if (dataset === 'adult') {
        if (studyGroup === 'static') {
            return adultStaticQuestionnaireConfig;
        } else {
            return adultQuestionnaireConfig;
        }
    } else if (dataset === 'diabetes') {
        return diabetesQuestionnaireConfig;
    }
